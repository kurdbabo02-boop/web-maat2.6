      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><Link to="/services/webdesign" className="hover:text-blue-400 transition-colors">Webdesign</Link></li>
              <li><Link to="/services/webshop" className="hover:text-blue-400 transition-colors">Webshops</Link></li>
              <li><Link to="/services/seo" className="hover:text-blue-400 transition-colors">SEO Optimalisatie</Link></li>
              <li><Link to="/services/ai-implementatie" className="hover:text-blue-400 transition-colors">AI Implementatie</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@web-maat.nl" className="hover:text-blue-400 transition-colors">info@web-maat.nl</a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-blue-500" />
                <a href="tel:+31600000000" className="hover:text-blue-400 transition-colors">+31 6 00000000</a>
              </li>
              <li className="pt-4">
                <Link to="/quote" className="inline-flex items-center gap-2 text-blue-500 font-bold hover:gap-3 transition-all">
